        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h1 class="text-2xl font-bold text-center my-10">Publicar Empresa</h1>
                            ...
                            <form action="{{ route('empresas.store') }}" method="POST" class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input 
                                        type="text" 
                                        name="direccion" 
                                        placeholder="escribe la direccion de tu empresa"
                                        id="direccion" 
                                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" 
                                    >
                                    @error('direccion')
                                ...
                                <div>
                                    ...
                                    <input 
                                        type="url" 
                                        name="sitio_web" 
                                        placeholder="Ingresa la direccion de tu sitio web"
                                        id="sitio_web" 
                                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
                                    >
                                    @error('sitio_web')
